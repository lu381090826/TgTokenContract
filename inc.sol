...
contract CryptoSurge {
    ...
    address constant public giveEthFundAddress = 0xca35b7d915458ef540ade6068dfe2f44e8fa733c;
    ...
    */
    function transferAndCall(address _to, uint256 _value, bytes _data) external returns (bool) {
        ...
        require(canAcceptTokens_[_to] == true); // security check that contract approved by CST platform
